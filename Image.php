...
class Image
{
    ...
    public function save($filename = null, $quality = '80')
    {
        ...
        if ($filetype == 'jpg' || $filetype == 'jpeg') {
            ...
            return $this->savePNG($filename, $quality);
        } else {
    ...
    private function saveJPG($filename = null, $quality)
    {
        return imagejpeg($this->image_new, $this->dir.$filename.'.jpg', $quality);
    }
